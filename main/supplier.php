<?php
// ============================================================
// SUPPLIER MANAGEMENT PAGE - MODERN UI/UX
// Fully responsive with styled modal popup
    ...
    <style>
        * {
        ...
        /* ============================================
           ...
           Modern, responsive popup for Add/Edit Supplier
        ============================================ */
        #facebox .popup {
...
<div class="app-container">
    ...
    <div class="app-content">
        ...
        <div class="page-header-modern" data-aos="fade-down">
            ...
            <div class="supplier-count-badge">
        ...
        <div class="breadcrumb-modern">
            ...
            <span class="text-dark fw-semibold">Suppliers</span>
        </div>
        ...
        // Get total suppliers
        $totalResult = $db->prepare("SELECT COUNT(*) as total FROM supliers");
        $totalResult->execute();
        $totalSuppliers = $totalResult->fetch(PDO::FETCH_ASSOC)['total'];
        ?>
        ...
        <div class="stats-grid" data-aos="fade-up" data-aos-delay="100">
            <div class="stat-card-mini">
                ...
                <div class="stat-info">
                    <h4 id="totalSuppliersCount"><?php echo $totalSuppliers; ?></h4>
                    <p>Total Suppliers</p>
                </div>
            </div>
            <div class="stat-card-mini">
        ...
        <div class="action-bar" data-aos="fade-up" data-aos-delay="150">
            <div class="search-wrapper">
                ...
                <input type="text" id="filter" placeholder="Search by name, contact person, address, or note..." autocomplete="off">
            </div>
            <a rel="facebox" href="addsupplier.php" class="btn-add-modern">
                <i class="fas fa-plus-circle"></i> Add New Supplier
            </a>
        </div>
        
        <!-- Suppliers Table -->
        <div class="suppliers-table-container" data-aos="fade-up" data-aos-delay="200">
            <table class="suppliers-table" id="resultTable">
                <thead>
                    <tr>
                        <th><i class="fas fa-building me-1"></i> Supplier</th>
                        <th><i class="fas fa-user me-1"></i> Contact Person</th>
                        <th><i class="fas fa-map-marker-alt me-1"></i> Address</th>
                        <th><i class="fas fa-phone me-1"></i> Contact No.</th>
                ...
                <tbody>
                    ...
                    ?>
                    <tr class="record">
                        <td><strong><?php echo htmlspecialchars($row['suplier_name']); ?></strong></td>
                        <td><?php echo htmlspecialchars($row['contact_person']); ?></td>
                        <td><?php echo htmlspecialchars($row['suplier_address']); ?></td>
                        <td><?php echo htmlspecialchars($row['suplier_contact']); ?></td>
                        <td><?php echo htmlspecialchars($row['note']); ?></td>
                        <td>
                            <a rel="facebox" href="editsupplier.php?id=<?php echo $row['suplier_id']; ?>" class="btn-edit" title="Edit Supplier">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="#" id="<?php echo $row['suplier_id']; ?>" class="btn-delete delbutton" title="Delete Supplier">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#filter").on("keyup", function() {
            ...
            $("#totalSuppliersCount").text(visibleCount);
            $(".supplier-count-badge strong").text(visibleCount);
        });
    });
            ...
            $.ajax({
                ...
                success: function() {
                    element.parents(".record").fadeOut('slow', function() {
                        ...
                        $("#totalSuppliersCount").text(newCount);
                        $(".supplier-count-badge strong").text(newCount);
                    });
                }
            });
        }
    ...
    $(document).ready(function() {
        ...
        $("#totalSuppliersCount").text(total);
        $(".supplier-count-badge strong").text(total);
    });
